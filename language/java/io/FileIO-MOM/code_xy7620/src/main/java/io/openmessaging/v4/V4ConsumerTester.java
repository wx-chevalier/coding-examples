...
public class V4ConsumerTester {

    static Logger logger = LoggerFactory.getLogger(V4ConsumerTester.class);
    //0表示默认;
...
//        ts[9].start();
        ...
        System.out.println("Consumer Finished, Cost {} ms, Num {}"+(end - start));
        //程序结束清理磁盘中存储的文件夹
